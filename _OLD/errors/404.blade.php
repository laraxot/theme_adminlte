...
@section('htmlheader_title')
    {{ trans('adm_theme::message.pagenotfound') }}
@endsection
...
@section('main-content')
    ...
    <div class="error-page">
        ...
        <div class="error-content">
            <h3><i class="fa fa-warning text-yellow"></i> Oops! {{ trans('adm_theme::message.pagenotfound') }}.</h3>
            <p>
                {{ trans('adm_theme::message.notfindpage') }}
