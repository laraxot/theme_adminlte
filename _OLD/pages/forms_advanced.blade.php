@extends('adm_theme::layouts.app')
  ...
  {{ Theme::add("/theme/plugins/iCheck/all.css") }}
  <!-- Bootstrap Color Picker -->
  {{ Theme::add("/theme/bc/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css") }}
  <!-- Bootstrap time Picker -->
  {{ Theme::add("/theme/plugins/timepicker/bootstrap-timepicker.min.css") }}
  <!-- Select2 -->
  {{ Theme::add("/theme/bc/select2/dist/css/select2.min.css") }}
  <!-- Theme style -->
...
--}}
{{ Theme::add("theme/bc/inputmask/dist/jquery.inputmask.bundle.js") }}
...
<!-- bootstrap color picker -->
{{ Theme::add("theme/bc/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js") }}
<!-- bootstrap time picker -->
{{ Theme::add("theme/plugins/timepicker/bootstrap-timepicker.min.js") }}
{{-- Theme::add("theme/bc/bootstrap-timepicker/js/bootstrap-timepicker.min.js") --}}

<!-- iCheck 1.0.1 -->
{{-- Theme::add("theme/plugins/iCheck/icheck.min.js") --}}
