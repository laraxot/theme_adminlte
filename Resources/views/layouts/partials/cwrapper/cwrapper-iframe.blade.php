...
<div class="content-wrapper iframe-mode {{ config('adm_theme::adminlte.classes_content_wrapper', '') }}" data-widget="iframe"
     data-auto-show-new-tab="{{ config('adm_theme::adminlte.iframe.options.auto_show_new_tab', true) }}"
     data-loading-screen="{{ config('adm_theme::adminlte.iframe.options.loading_screen', true) }}"
     data-use-navbar-items="{{ config('adm_theme::adminlte.iframe.options.use_navbar_items', true) }}">

    {{-- IFrame Navbar --}}
    <div class="nav navbar navbar-expand navbar-white navbar-light border-bottom p-0">

        {{-- Close Buttons --}}
        @if(config('adm_theme::adminlte.iframe.buttons.close_all', true) || config('adm_theme::adminlte.iframe.buttons.close_all_other', true))
        ...
        @elseif(config('adm_theme::adminlte.iframe.buttons.close', false))
        ...
        {{-- Scroll Left Button --}}
        @if(config('adm_theme::adminlte.iframe.buttons.scroll_left', true))
        ...
        <ul class="navbar-nav" role="tablist">
            ...
            {{-- Default Tab --}}
            @if(! empty(config('adm_theme::adminlte.iframe.default_tab.url')))
                <li class="nav-item active" role="presentation">
                    <a id="tab-default" class="nav-link active" data-toggle="row" href="#panel-default"
                       role="tab" aria-controls="panel-default" aria-selected="true">
                        ...
                        {{ config('adm_theme::adminlte.iframe.default_tab.title') ?: __('adminlte::iframe.tab_home') }}
                    </a>
                </li>
            @endif
        ...
        {{-- Scroll Right Button --}}
        @if(config('adm_theme::adminlte.iframe.buttons.scroll_right', true))
        ...
        {{-- Fullscreen Button --}}
        @if(config('adm_theme::adminlte.iframe.buttons.fullscreen', true))
    ...
    <div class="tab-content">
        ...
        @if(! empty(config('adm_theme::adminlte.iframe.default_tab.url')))
            <div id="panel-default" class="tab-pane fade active show" role="tabpanel" aria-labelledby="tab-default">
                ...
                <iframe src="{{ config('adm_theme::adminlte.iframe.default_tab.url') }}" style="height: 671px;"></iframe>
            </div>
        @endif
