    ...
    <div class="lockscreen-wrapper">
        ...
        <div class="lockscreen-logo">
            <a href="{{ $dashboard_url }}">
                <img src="{{ Theme::asset(config('adm_theme::adminlte.logo_img')) }}" height="50">
        ...
        <div class="lockscreen-item">
            ...
            <form method="POST" action="{{ route('password.confirm') }}"
                class="lockscreen-credentials @if (!config('adm_theme::adminlte.usermenu_image'))ml-0 @endif">
                @csrf
